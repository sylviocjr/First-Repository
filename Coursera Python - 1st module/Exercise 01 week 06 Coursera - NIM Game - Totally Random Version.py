...
### Both moves, either from the user or the computer, are randomly generated ###

### Palavras-chave: Jogo de NIM; funções; funções em Python ###
### Este programa executa o Jogo de NIM usando entradas aleatórias ###
### Nesta versão, ambas as jogadas, sejam do usuário ou do computador, são geradas randomicamente ###
