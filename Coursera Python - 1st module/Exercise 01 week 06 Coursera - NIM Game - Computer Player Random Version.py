...
### Nesta versão, o usuário deve informar o número de peças a retirar. O número de peças do computador é gerado aleatoriamente ### ###
### Implementar rotina de encerramento do jogo ao final, evitando que entre novamente no menu ###
### Testar melhor; pesquisar bugs ###
...
############################################## ALTERNÂNCIA #################################
        while n > 0:
            ...
            print("Agora restam",n,"peças no tabuleiro.", end = '\n\n')

            if n == 0:
                pontoParaUsuario += 1
                print("Você ganhou!")
                print(pontoParaUsuario,"ponto(s) para você !!")   
      ...
      ### ROTINA COMPUTADOR CONTINUA ###  
            ...
            if n == 0:
                ...
                print(pontoParaComputador,"ponto(s) para o computador !!")   
                break   ### Interrompe caso o fim de jogo tenha ocorrido neste ponto, impedindo que o usuário continue. ###
...
def usuario_escolhe_jogada(a,b):
    ...
    while retirar <=0 or retirar > b or retirar > a:
        retirar = int(input("Quantas peças você vai retirar? "))
        if retirar <=0 or retirar > b or retirar > a:   ### Rotina de validação ###
            print("Oops! Jogada inválida! Tente de novo.")
    return retirar


def computador_escolhe_jogada(a,b):   ### Validação !!! Peças a retirar não pode ser > a ###
    retirar = 0   # Força entrada no loop a seguir ...
    while retirar == 0 or retirar > a:
        retirar = random.randint(1,b)   ### Neste ponto se gera aleatoriamento o número de peças do computador ###
