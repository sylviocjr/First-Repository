...
### Both players must input their moves. The user plays the role of the computer ###

### Palavras-chave: Jogo de NIM; funções; funções em Python ###
### Este programa executa o Jogo de NIM usando entradas aleatórias ###
### Nesta versão, o usuário e o computador devem informar o número de peças a retirar. O jogador faz vezes de computador ###
