...
tentativas = 0
while True:
    QA = random.randint(0, 390)
    QB = random.randint(0, 33)
    QC = random.randint(0, 20)
    QD = random.randint(0, 46)
    QE = random.randint(0, 11)
    tentativas += 1
    ...
    if (lucro >= 1863.50) and (restricao_couro <= 390) and (restricao_couraca <= 96) and (restricao_tempo <= 3200):
        break
# Valor máximo encontrado foi R$ 1863,90 (Excel Solver)

print("Lucro: $$ {:.2f}".format(lucro))
print("Variáveis: QA(390) = {}, QB(33) = {}, QC(20) = {}, QD(46) = {}, QE(11) = {}.".format(QA, QB, QC, QD, QE))
print("Restrição de couro(390): ", restricao_couro)
print("Restrição de couraça(96): ", restricao_couraca)
